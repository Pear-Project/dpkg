      ...
      char *argv[])
{
  ...
  g_setenv ("PULSE_PROP_application.icon_name", EPHY_ICON_NAME, TRUE);
  ...
  if (private_instance) {
    ...
    g_set_prgname ("pafari");
    g_set_application_name (_("Pafari"));

    gtk_window_set_default_icon_name (EPHY_ICON_NAME);
  }
